...
## What this is
A PWA (Progressive Web App) + iOS Scriptable widget for tracking a USMLE Step 1 study schedule. Deployed on Vercel, source on GitHub at https://github.com/momohaid/Step1.
...
## Schedule data
`const SCHEDULE = [...]` on line 229 of `index.html` — a single JSON array of day objects.
...
```
`.day.rest { background: #111622; }` — `.sk-title { color: #8899bb; }`
